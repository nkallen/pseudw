...
class Game
  ...
  class GameView
    ...
    showTurn: (participles) ->
      ...
      $card.find(".translation .lemma").text(participles[0].verb.lemma)
      $card.find(".translation .english").text(participles[0].verb.translation)
